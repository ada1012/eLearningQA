...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|c|c|c|}
			...
			GitHub Copilot           & \begin{tabular}[c]{@{}c@{}}GitHub Copilot es una\\ herramienta de inteligencia artificial\end{tabular}                                     & GitHub, Inc.               \\ \hline
		\end{tabular}%
	}
\end{table}
La licencia pública de Eclipse (EPL) es compatible con estas licencias sin contar GitHub Copilot, a continuación se mencionan sus posibilidades y obligaciones.
\begin{itemize}
